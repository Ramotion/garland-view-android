...
public class TailLayoutManagerOld extends RecyclerView.LayoutManager
    ...
    public TailLayoutManagerOld(@NonNull Context context) {
        super();
    ...
    public int scrollHorizontallyBy(int dx, RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        if (mRecyclerView != null) {
            for (int i = 0, cnt = getChildCount(); i < cnt; i++) {
                final TailItemOld vh = (TailItemOld) mRecyclerView.getChildViewHolder(getChildAt(i));
                if (vh.isScrolling()) {
                    return 0;
                }
            }
